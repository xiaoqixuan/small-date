...
module.exports = {
  dev: {
    ...
    proxyTable: {
        '/api/**': {
            ...
            target: 'https://www.guaiyun.store/scrm-web/', //表示你跨域请求的接口的域名
    ...
    // host: '192.168.70.204', // can be overwritten by process.env.HOST
  ...
  build: {
    ...
    // Paths
    assetsRoot: path.resolve(__dirname, '../dist/xyh/'),
    assetsSubDirectory: 'static',
    assetsPublicPath: './xyh/',
